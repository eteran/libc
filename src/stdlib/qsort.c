...
//----------------------------------------------------------------------------*/
static void __elibc_memswp64(uint64_t *__ELIBC_RESTRICT dest, uint64_t *__ELIBC_RESTRICT src, size_t n) {
	n /= 8;
	while(n--) {
...
//----------------------------------------------------------------------------*/
static void __elibc_memswp32(uint32_t *__ELIBC_RESTRICT dest, uint32_t *__ELIBC_RESTRICT src, size_t n) {
	n /= 4;
	while(n--) {
...
//----------------------------------------------------------------------------*/
static void __elibc_memswp16(uint16_t *__ELIBC_RESTRICT dest, uint16_t *__ELIBC_RESTRICT src, size_t n) {
	n /= 2;
	while(n--) {
...
//----------------------------------------------------------------------------*/
static void __elibc_memswp8(uint8_t *__ELIBC_RESTRICT dest, uint8_t *__ELIBC_RESTRICT src, size_t n) {
	while(n--) {
...
// Name: memswp
//----------------------------------------------------------------------------*/
static void *memswp(void *__ELIBC_RESTRICT dest, void *__ELIBC_RESTRICT src, size_t n) {
