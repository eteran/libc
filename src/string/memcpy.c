...
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_memcpy64(uint64_t *_RESTRICT dest, const uint64_t *_RESTRICT src,
                                            size_t n) {
	n /= 8;
	while (n--) {
		*dest++ = *src++;
...
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_memcpy32(uint32_t *_RESTRICT dest, const uint32_t *_RESTRICT src,
                                            size_t n) {
	n /= 4;
	while (n--) {
		*dest++ = *src++;
...
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_memcpy16(uint16_t *_RESTRICT dest, const uint16_t *_RESTRICT src,
                                            size_t n) {
	n /= 2;
	while (n--) {
		*dest++ = *src++;
...
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_memcpy8(uint8_t *_RESTRICT dest, const uint8_t *_RESTRICT src,
                                           size_t n) {
	while (n--) {
		*dest++ = *src++;
	}
