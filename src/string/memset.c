...
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_memset64(uint64_t *p, char ch, size_t n) {
...
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_memset32(uint32_t *p, char ch, size_t n) {
...
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_memset16(uint16_t *p, char ch, size_t n) {
...
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_memset8(uint8_t *p, char ch, size_t n) {
	while (n--) {
		*p++ = (uint8_t)ch;
	}
}
