...
// Desc:
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_feclearexcept_fpu(int excepts) {
	fenv_t envp;
	FPU_GETENV(envp);
...
// Desc:
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_feclearexcept_sse(int excepts) {
	uint32_t xcw;
	SSE_GETCW(xcw);
...
// Desc:
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_fesetround_fpu(int round) {
...
// Desc:
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_fesetround_sse(int round) {
	uint32_t xcw;
	SSE_GETCW(xcw);
...
// Desc:
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static int __elibc_fegetround_fpu(void) {
	uint16_t cw;
	FPU_GETCW(cw);
...
// Desc:
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_feraiseexcept_fpu(int excepts) {
	fenv_t envp;
	FPU_GETENV(envp);
	envp.__status_word |= (excepts & FE_ALL_EXCEPT);
	FPU_SETENV(envp);
...
// Desc:
//----------------------------------------------------------------------------*/
_ENSURE_INLINE static void __elibc_feraiseexcept_sse(int excepts) {
	uint32_t xcw;
	SSE_GETCW(xcw);
	xcw |= (excepts & FE_ALL_EXCEPT);
	SSE_SETCW(xcw);
